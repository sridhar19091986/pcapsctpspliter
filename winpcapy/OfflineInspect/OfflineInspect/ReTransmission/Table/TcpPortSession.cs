...
namespace OfflineInspect.ReTransmission.Table
{
    ...
    public class TcpPortSession : CommonToolx, IDisposable
    {
        ...
        private int min_file_num = Int32.Parse(CommonAttribute.TlliTcpSession[3]);
        private int max_file_num = Int32.Parse(CommonAttribute.TlliTcpSession[4]);

        private int size = Int32.Parse(CommonAttribute.TlliTcpSession[5]);
