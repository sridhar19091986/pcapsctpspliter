...
namespace OfflineInspect.ReTransmission
{
    public class CommonAttribute : CommonDataLocation
    {
        ...
        public static string[] TlliTcpSession = new String[] { "TlliTcpSession", db, remote, "0", "5", "50000" };
        public static string[] TlliLLCSession = new String[] { "TlliLLCSession", db, remote, "0", "2", "5000" };
        public static string[] TcpRetransStatics = new String[] { "TcpRetransStatics", db, remote };
        public static string[] LacCellBvciStatics = new string[] { "LacCellBvciStatics", db, remote };
    }
}
