...
namespace EntitySqlTable.SqlServer.ip209.GuangZhou.GbFlowControlms
{
    #region Contexts
    ...
    /// </summary>
    public partial class GuangZhou_GbEntities_fc_ms : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GuangZhou_GbEntities_fc_ms object using the connection string found in the 'GuangZhou_GbEntities_fc_ms' section of the application configuration file.
        /// </summary>
        public GuangZhou_GbEntities_fc_ms() : base("name=GuangZhou_GbEntities_fc_ms", "GuangZhou_GbEntities_fc_ms")
        {
        ...
        /// <summary>
        /// Initialize a new GuangZhou_GbEntities_fc_ms object.
        /// </summary>
        public GuangZhou_GbEntities_fc_ms(string connectionString) : base(connectionString, "GuangZhou_GbEntities_fc_ms")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GuangZhou_GbEntities_fc_ms object.
        /// </summary>
        public GuangZhou_GbEntities_fc_ms(EntityConnection connection) : base(connection, "GuangZhou_GbEntities_fc_ms")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="GuangZhou_GbModel1", Name="Gb_FlowControlx")]
    [Serializable()]
