...
namespace EntitySqlTable.SqlServer.ip209.GuangZhou.GnGET
{
    #region Contexts
    ...
    /// </summary>
    public partial class GuangZhou_GnGET : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GuangZhou_GnGET object using the connection string found in the 'GuangZhou_GnGET' section of the application configuration file.
        /// </summary>
        public GuangZhou_GnGET() : base("name=GuangZhou_GnGET", "GuangZhou_GnGET")
        {
        ...
        /// <summary>
        /// Initialize a new GuangZhou_GnGET object.
        /// </summary>
        public GuangZhou_GnGET(string connectionString) : base(connectionString, "GuangZhou_GnGET")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GuangZhou_GnGET object.
        /// </summary>
        public GuangZhou_GnGET(EntityConnection connection) : base(connection, "GuangZhou_GnGET")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
