...
namespace MultiGnGi
{
    public class LacCellBvci
    {
        ...
        public void BulkMongo(List<LacCellBvci> lcb)
        {
            ...
            db.DropCollection("LacCellBvci");
            var collection = db["LacCellBvci"];
        ...
        public IQueryable<LacCellBvci> QueryMongo()
        {
            ...
            var db = mongo["guangzhou_gb"];
            var collection = db.GetCollection("LacCellBvci");
        ...
        public List<LacCellBvci> ListLacCellBvci
        {
            get
            {
                ...
                {
                    listlaccellbvci = new List<LacCellBvci>();
    ...
    public class FlowControlOneBvc
    {
        ...
        private MongoCollection FCOB_col
        {
            get
            {
                if (fcob_col == null)
                {
                    ...
                    var mongo = MongoServer.Create(serverSettings);
                    var db = mongo["guangzhou_gb_one_bvc"];

                    db.DropCollection("FlowControlOneBvc");
                    fcob_col = db["FlowControlOneBvc"];
                }
                return fcob_col;
            }
            set
        ...
        public void BulkMongo(List<FlowControlOneBvc> fcob)
        {
            ...
            db.DropCollection("FlowControlOneBvc");
            var collection = db["FlowControlOneBvc"];
        ...
        public IQueryable<FlowControlOneBvc> QueryMongo()
        {
            ...
            var db = mongo["guangzhou_gb_one_bvc"];
            var collection = db.GetCollection("FlowControlOneBvc");
    ...
    public class FlowControlMapBvc
    {
        ...
        public void BulkMongo(List<FlowControlMapBvc> fcmb)
        {
            ...
            var mongo = MongoServer.Create(serverSettings);
            var db = mongo["guangzhou_gb_map_bvc"];

            db.DropCollection("FlowControlMapBvc");
            var collection = db["FlowControlMapBvc"];
        ...
        public IQueryable<FlowControlMapBvc> QueryMongo()
        {
            ...
            var db = mongo["guangzhou_gb_map_bvc"];
            var collection = db.GetCollection("FlowControlMapBvc");
