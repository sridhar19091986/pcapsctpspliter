...
namespace GnPlatForm.SqlServer
{
    ...
    /// </summary>
    public partial class GuangZhou_GnEntities4 : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GuangZhou_GnEntities4 object using the connection string found in the 'GuangZhou_GnEntities4' section of the application configuration file.
        /// </summary>
        public GuangZhou_GnEntities4() : base("name=GuangZhou_GnEntities4", "GuangZhou_GnEntities4")
        {
        ...
        /// <summary>
        /// Initialize a new GuangZhou_GnEntities4 object.
        /// </summary>
        public GuangZhou_GnEntities4(string connectionString) : base(connectionString, "GuangZhou_GnEntities4")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GuangZhou_GnEntities4 object.
        /// </summary>
        public GuangZhou_GnEntities4(EntityConnection connection) : base(connection, "GuangZhou_GnEntities4")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="GuangZhou_GnModel4", Name="Gb_IP_Fragment")]
    [Serializable()]
