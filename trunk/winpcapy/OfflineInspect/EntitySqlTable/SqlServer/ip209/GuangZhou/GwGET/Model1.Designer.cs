...
namespace EntitySqlTable.SqlServer.ip209.GuangZhou.GwGET
{
    #region Contexts
    ...
    /// </summary>
    public partial class GuangZhou_GwGET : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GuangZhou_GwGET object using the connection string found in the 'GuangZhou_GwGET' section of the application configuration file.
        /// </summary>
        public GuangZhou_GwGET() : base("name=GuangZhou_GwGET", "GuangZhou_GwGET")
        {
        ...
        /// <summary>
        /// Initialize a new GuangZhou_GwGET object.
        /// </summary>
        public GuangZhou_GwGET(string connectionString) : base(connectionString, "GuangZhou_GwGET")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GuangZhou_GwGET object.
        /// </summary>
        public GuangZhou_GwGET(EntityConnection connection) : base(connection, "GuangZhou_GwGET")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
