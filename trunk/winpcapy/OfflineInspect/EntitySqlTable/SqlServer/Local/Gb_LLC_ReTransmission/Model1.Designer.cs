...
namespace EntitySqlTable.SqlServer.Local.Gb_LLC_ReTransmission
{
    #region Contexts
    ...
    /// </summary>
    public partial class GuangZhou_Gb_LLC_ReTransmission : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GuangZhou_Gb_LLC_ReTransmission object using the connection string found in the 'GuangZhou_Gb_LLC_ReTransmission' section of the application configuration file.
        /// </summary>
        public GuangZhou_Gb_LLC_ReTransmission() : base("name=GuangZhou_Gb_LLC_ReTransmission", "GuangZhou_Gb_LLC_ReTransmission")
        {
        ...
        /// <summary>
        /// Initialize a new GuangZhou_Gb_LLC_ReTransmission object.
        /// </summary>
        public GuangZhou_Gb_LLC_ReTransmission(string connectionString) : base(connectionString, "GuangZhou_Gb_LLC_ReTransmission")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GuangZhou_Gb_LLC_ReTransmission object.
        /// </summary>
        public GuangZhou_Gb_LLC_ReTransmission(EntityConnection connection) : base(connection, "GuangZhou_Gb_LLC_ReTransmission")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="GuangZhou_GbModel3", Name="Gb_LLC_ReTransmission")]
    [Serializable()]
