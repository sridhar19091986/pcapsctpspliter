...
namespace EntitySqlTable.SqlServer.Local.Gb_TCP_ReTransmission
{
    #region Contexts
    ...
    /// </summary>
    public partial class GuangZhou_Gb_TCP_ReTransmission : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new GuangZhou_Gb_TCP_ReTransmission object using the connection string found in the 'GuangZhou_Gb_TCP_ReTransmission' section of the application configuration file.
        /// </summary>
        public GuangZhou_Gb_TCP_ReTransmission() : base("name=GuangZhou_Gb_TCP_ReTransmission", "GuangZhou_Gb_TCP_ReTransmission")
        {
        ...
        /// <summary>
        /// Initialize a new GuangZhou_Gb_TCP_ReTransmission object.
        /// </summary>
        public GuangZhou_Gb_TCP_ReTransmission(string connectionString) : base(connectionString, "GuangZhou_Gb_TCP_ReTransmission")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new GuangZhou_Gb_TCP_ReTransmission object.
        /// </summary>
        public GuangZhou_Gb_TCP_ReTransmission(EntityConnection connection) : base(connection, "GuangZhou_Gb_TCP_ReTransmission")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="GuangZhou_GbModel2", Name="Gb_TCP_ReTransmission")]
    [Serializable()]
