...
namespace OfflineInspect.ReTransmission.Table
{
    ...
    public class TlliLLCSession : CommonToolx, IDisposable
    {
        ...
        private int min_file_num = Int32.Parse(CommonAttribute.TlliLLCSession[3]);
        private int max_file_num = Int32.Parse(CommonAttribute.TlliLLCSession[4]);

        private int size = Int32.Parse(CommonAttribute.TlliLLCSession[5]);
