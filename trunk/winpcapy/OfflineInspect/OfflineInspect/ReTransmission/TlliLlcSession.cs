...
namespace OfflineInspect.ReTransmission
{
    ...
    public class TlliLLCSession : CommonToolx, IDisposable
    {
        ...
        public MongoCrud<TlliLLCSessionDocument> mongo_tts;
        private GuangZhou_Gb_TCP_ReTransmission gb;

        public TlliLLCSession()
        {
            mongo_tts = new MongoCrud<TlliLLCSessionDocument>(mongo_conn, mongo_db, mongo_collection);
        ...
        public void CreateTable(string direction, IEnumerable<Gb_TCP_ReTransmission> gb_tcp_retrans)
        {
            ...
            for (int i = 0; i < step; i++)
            {
                ...
                foreach (var m in tcp_sessions)
                {
                    ...
                    TlliLLCSessionDocument tcps = new TlliLLCSessionDocument();
